<#
.Synopsis
   Aternity - Remediation Script: Enable-SHMobileOptimization
.DESCRIPTION
	Enable optimization on the SteelHead mobile agent
...
.EXAMPLE
   ...
   Action Name: Enable-SHMobileOptimization
   Description: Enable optimization on the SteelHead mobile agent
