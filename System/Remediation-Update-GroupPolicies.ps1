<#
.Synopsis
   Aternity - Remediation Script: Update-GroupPolicies
.DESCRIPTION
	Update Group Policies (GPO)
	Use case: Force GPO for compliance
...
.EXAMPLE
   ...
   Action Name: Update-GroupPolicies
   Description: Update Group Policies (GPO)
...
if ($LastExitCode -ne 0) { throw "GP update failed" }
